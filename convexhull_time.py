...
def theta(ptA, ptB):
    '''computes an approximation of the angle between the 
    line AB and a horizontal line through A'''
...
def giftwrap(listPts):
    ...
    #set the end time and compute the procedure time
    end_time = time.time() - start_time
    print('The runnning time of Giftwrap is : {}'.format(end_time))
...
def grahamscan(listPts):
    ...
    print('The runnning time is of Graham-scan : {}'.format(proc_time))
    print('The amount of vertices : {}'.format(len(chull)))
...
def amethod(listPts):
    ...
    #set the end time and compute the procedure time
    proc_time = time.time() - start_time
    print('The runnning time is of Monotone Chain : {}'.format(proc_time))    
    print('The amount of vertices : {}'.format(len(chull)))
